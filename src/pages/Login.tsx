            ...
            <form className="space-y-6" onSubmit={handleSubmit} autoComplete="on">
              ...
              <div className="relative">
                ...
                >
                  {showPassword ? (
                    // Eye-slash SVG
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10 0-1.657.403-3.22 1.125-4.575m2.197-2.197A9.956 9.956 0 0112 3c5.523 0 10 4.477 10 10 0 2.21-.715 4.25-1.925 5.925M15 12a3 3 0 11-6 0 3 3 0 016 0zm-7.071 7.071l12.142-12.142" /></svg>
                  ) : (
                    // Eye SVG
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0zm-9 0c0-5.523 4.477-10 10-10s10 4.477 10 10-4.477 10-10 10S3 17.523 3 12z" /></svg>
                  )}
                </span>
              </div>
